...
var UnconfiguredInteraction = /** @class */ (function () {
    ...
    function UnconfiguredInteraction(pact, interaction, opts) {
        this.pact = pact;
    ...
    UnconfiguredInteraction.prototype.given = function (state, parameters) {
        ...
        if (parameters) {
            (0, ramda_1.forEachObjIndexed)(function (v, k) {
                _this.interaction.givenWithParam(state, "".concat(k), JSON.stringify(v));
            }, parameters);
        }
        else {
...
var InteractionwithRequest = /** @class */ (function () {
    // tslint:disable:no-empty-function
    function InteractionwithRequest(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
...
var InteractionWithResponse = /** @class */ (function () {
    // tslint:disable:no-empty-function
    function InteractionWithResponse(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
    InteractionWithResponse.prototype.executeTest = function (testFn) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, executeTest(this.pact, this.opts, testFn)];
            });
        });
    };
...
var InteractionWithPlugin = /** @class */ (function () {
    // tslint:disable:no-empty-function
    function InteractionWithPlugin(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
    ...
    InteractionWithPlugin.prototype.withRequest = function (method, path, builder) {
        ...
        return new InteractionWithPluginRequest(this.pact, this.interaction, this.opts);
    };
...
var InteractionWithPluginRequest = /** @class */ (function () {
    // tslint:disable:no-empty-function
    function InteractionWithPluginRequest(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
    InteractionWithPluginRequest.prototype.willRespondWith = function (status, builder) {
        ...
        return new InteractionWithPluginResponse(this.pact, this.interaction, this.opts);
    };
...
var InteractionWithPluginResponse = /** @class */ (function () {
    // tslint:disable:no-empty-function
    function InteractionWithPluginResponse(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
...
var cleanup = function (success, pact, opts, server) {
    if (success) {
...
var executeTest = function (pact, opts, testFn) { return __awaiter(void 0, void 0, void 0, function () {
